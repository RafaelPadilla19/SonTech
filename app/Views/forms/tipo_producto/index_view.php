<main class="content">
    ...
    <div class="table-responsive p-2">
        <table class="table table-striped table-hover table-bordered" id="table-tipoproducto">
            <thead>
                <tr>
                    <th>ID</th>
...
$("#btnNuevo").click(function() {
    ...
    $("#modal-title").text('Nuevo Tipo Producto');
...
$(document).on('click', '.btnEditar', function() {
    ...
    //$('#form-personas').trigger('reset');
    $("#modal-title").text('Actualizar Tipo Producto');
