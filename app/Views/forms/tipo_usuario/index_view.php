<main class="content">
    ...
    <a href="<?php echo base_url(); ?>/TipoUsuario/eliminados" id="btnNuevo" class="btn btn-info mb-3 mt-3">Ver Eliminados</a>
    ...
    <div class="table-responsive p-2">
        <table class="table table-striped table-hover table-bordered" id="table-tipousuario">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url().'/TipoUsuario/eliminar/'.$dato['tipousuario_id'];?>"
    ...
    <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form id="form-personas" method="post" action='<?php echo base_url();?>/TipoUsuario/action'>
...
$(document).on('click', '.btnEditar', function() {
    ...
    //$('#form-personas').trigger('reset');
    $("#modal-title").text('Actualizar Tipo Usuario');
